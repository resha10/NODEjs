...
export const footerLinks = [
  {
    ...
    links: [
      { text: "Home", url: "/" },
      { text: "Popular Products", url: "/products" },
...
export const features = [
  {
    ...
    description: "We deliver and assemble furniture at your doorstep.",
  },
  {
    icon: leaf_icon,
    title: "Premium Quality",
    description: "Handcrafted furniture with premium materials.",
  },
  {
    icon: coin_icon,
